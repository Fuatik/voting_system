...
import static com.example.voting_system.web.user.ProfileController.REST_URL;
import static com.example.voting_system.web.user.UniqueEmailValidator.EXCEPTION_DUPLICATE_EMAIL;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void update() throws Exception {
        ...
        USER_MATCHER.assertMatch(repository.getExisted(USER_ID), UserUtil.updateFromTo(new User(user), updatedTo));
    }
